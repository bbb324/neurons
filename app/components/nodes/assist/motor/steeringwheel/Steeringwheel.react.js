      ...
      <div className={'node-actual node-type-' + this.props.info.name} id={this.props.id} style={{
        ...
        <div className='node-body node-draggable hide-config'>
           <div className='node-actual-body'>
            <span className="direction-setting">{languages.getTranslation('direction-setting')}</span>
            <div className='port-value'>
              <span className="speed">{languages.getTranslation('speed')}</span>
              <span className="line"></span>
              <span className="direction">{languages.getTranslation('direction')}</span>
             </div>
          </div>       
        </div>
